import galleryImg15 from "../assets/gallery-img-15.jpg";
import galleryImg12 from "../assets/gallery-item-12.jpg";
import galleryImg1 from "../assets/gallery-item-1.jpg";
import galleryImg5 from "../assets/gallery-img-5.jpg";
import galleryImg6 from "../assets/gallery-img-6.jpg";
import exploreImg3 from "../assets/explore-card__image-03.jpg";
import exploreImg2 from "../assets/explore-card__image-02.jpg";
import exploreImg1 from "../assets/explore-card__image-01.jpg";
import logo from '../assets/Winter-world-logo.svg'
import carnivalLogo from '../assets/carnival-logo.svg'
import bubbleDomeLogo from '../assets/bubble-dome-logo.svg'
    ...
    <main>
      ...
      <section className="explore__cards flex">
        <div className="explore-card flex flex--column">
          <div
            style={{
              backgroundImage: `url(${exploreImg3})`,
            }}
            className="explore-card__image"
          >
            <img src={logo} alt="Winterworld-logo" />
          </div>
          <a
        ...
        <div className="explore-card flex flex--column">
          <div
            style={{
              backgroundImage: `url(${exploreImg2})`,
            }}
            className="explore-card__image"
          >
            <img
        ...
        <div className="explore-card flex flex--column">
          <div
            style={{
              backgroundImage: `url(${exploreImg1})`,
            }}
            className="explore-card__image"
          >
            <img src={bubbleDomeLogo} alt="bubble-dome-logo" />
          </div>
          <a
      ...
      <section className="gallery">
        ...
        <div style={{ backgroundColor: "#eb003f" }} className="gallery__item">
          <img src={svg} className="gallery__item-svg" />
        </div>
        <div
          style={{ backgroundImage: `url(${galleryImg15})` }}
        ...
        <div
          style={{ backgroundImage: `url(${galleryImg5})` }}
          className="gallery__item"
        />
        <div
        ...
        <div
          style={{ backgroundImage: `url(${galleryImg12})` }}
          className="gallery__item gallery__item--wide"
        />
        <div className="gallery__item gallery__item--blue">
          <img src={svg} className="gallery__item-svg" />
